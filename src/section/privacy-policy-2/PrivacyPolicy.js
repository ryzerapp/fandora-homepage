                ...
                <div className="bs-container">
                    <div className="row  max-sm:px-5">
                        <div className="col-12">
                            <h1 className="text-[#444762] poppins-600 text-[30px] xs:text-[40px] lg:text-[60px]">Privacy Policy</h1>
