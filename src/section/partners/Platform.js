"use client";
import { platformFaq } from "@/assets/data/accordian";
                ...
                <div className="row justify-center lg:justify-between">
                    ...
                    <div className="col-xl-5 max-lg:mt-20 col-lg-6 col-12 flex items-center">
                        <div>
                            ...
                            <h2 className="md:leading-[55px] xs:leading-[45px] leading-[32px]  max-lg:text-center  text-[23px] xs:text-[26px] sm:text-[30px] md:text-[35px] xl:text-[40px] poppins-700 text-[#45485F]">Dedicated Channel Partner Dashboard</h2>
                            <div className="sm:pl-5 pt-5 lg:pt-10">
                                <Accordion transition transitionTimeout={300}>
                                    {
                                        platformFaq.map((item, index) => (
