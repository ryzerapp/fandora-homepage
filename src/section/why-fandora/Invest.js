        ...
        <section className="lg:py-20 pb-20">
            <div className="bs-container">
                <div className="row justify-center">
                    <div className="col-lg-11 col-sm-9 col-11">
                        <div className="row">
                                    ...
                                    <div className="xl:mt-8 mt-5 flex max-xl:justify-center">
                                        <div>
                                            <div className="flex-items-center  my-5">
                                                ...
                                                <p className="mb-0 max-sm:text-sm ml-4 poppins-500 ">
                                                    Be part of an LLP & become a co-owner.
                                                </p>
                                            </div>
                                            <div className="flex-items-center my-5">
                                                <div className="text-[#52C1B9] hover:text-[white] transition-all hover:bg-[#52C1B9] w-[30px] h-[30px] flex-center rounded-[50%] bg-[#F0F4FE]">
                                                ...
                                                <p className="mb-0 max-sm:text-sm ml-4 poppins-500 ">
                                                    Be a decision-maker through voting rights.
                                                </p>
                                            </div>
                                            <div className="flex-items-center my-5">
                                                <div className="text-[#52C1B9] hover:text-[white] transition-all hover:bg-[#52C1B9] w-[30px] h-[30px] flex-center rounded-[50%] bg-[#F0F4FE]">
                ...
                <div className="row mt-20 justify-center">
                    <div className="col-lg-11 col-sm-9 col-11">
                        <div className="row justify-center">
                            <div className="col-xxl-6 col-lg-6  max-lg:mt-10 px-20">
                                {/* <div className="rz-feature-image-circle flex-center w-[85%] lg:w-[90%] xl:w-[78%] h-[100%] rounded-[50%]">
                                    <div className="flex-center">
                                        <img className="w-[80%]" src={`/assets/img/png/rocket.png`} />
                                    </div>
                                </div> */}
                                    ...
                                    <div className="mt-5 xl:mt-8 flex max-xl:justify-center">
                                        <div>
                                            <div className="flex-items-center  my-5">
                                                ...
                                                <p className="mb-0 max-sm:text-sm ml-4 poppins-500 ">
                                                    Member first de-centralized governance model
                                                </p>
                                            </div>
                                            <div className="flex-items-center my-5">
                                                <div className="text-[#52C1B9] hover:text-[white] transition-all hover:bg-[#52C1B9] w-[30px] h-[30px] flex-center rounded-[50%] bg-[#F0F4FE]">
                                                ...
                                                <p className="mb-0 max-sm:text-sm ml-4 poppins-500 ">
                                                    Ownership transfers, Capital decisions by the members for the members.
                                                </p>
                                            </div>
                                            <div className="flex-items-center my-5">
                                                <div className="text-[#52C1B9] hover:text-[white] transition-all hover:bg-[#52C1B9] w-[30px] h-[30px] flex-center rounded-[50%] bg-[#F0F4FE]">
                                                ...
                                                <p className="mb-0 max-sm:text-sm ml-4 poppins-500 ">
                                                    Quick & simple process of voting & decisions.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
